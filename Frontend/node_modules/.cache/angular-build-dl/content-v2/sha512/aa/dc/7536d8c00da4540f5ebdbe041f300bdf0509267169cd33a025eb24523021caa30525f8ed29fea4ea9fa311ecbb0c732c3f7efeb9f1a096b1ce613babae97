(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StudentService = /** @class */ (function () {
                ...
                StudentService.prototype.getStudent = function (i) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SurveyComponent = /** @class */ (function () {
                function SurveyComponent(studentService, router) {
                    this.studentService = studentService;
                    this.router = router;
                ...
                SurveyComponent.prototype.submitForm = function () {
                    var _this = this;
                    this.newStudent.thingsYouLiked = '[' + this.thingsLiked.join() + ']';
                    console.log(this.newStudent);
                    var mean = this.meanCalculator();
                    // The Post request.
                    this.studentService.createStudent(this.newStudent).subscribe(function () {
                        _this.router.navigate(["/win-lose/" + mean]);
                    });
                };
                SurveyComponent.prototype.meanCalculator = function () {
                    var list = this.listofNumbers.split(',').map(Number);
                    var mean = 0;
                ...
                SurveyComponent.prototype.onCheckboxChange = function (event, value) {
                    if (event.target.checked) {
                        this.thingsLiked.push(value);
                    }
                    if (!event.target.checked) {
                        var index = this.thingsLiked.indexOf(value);
                        if (index > -1) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _student_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../student.service */ "./src/app/student.service.ts");
            var WinLosePageComponent = /** @class */ (function () {
                function WinLosePageComponent(studentService, route) {
                    this.studentService = studentService;
                    this.route = route;
                }
                WinLosePageComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.params.subscribe(function (params) {
                        _this.mean = +params['mean'];
                    });
                    this.studentService.getStudents().subscribe(function (students) {
                        _this.students = students;
                    });
                };
                return WinLosePageComponent;
            }());
            WinLosePageComponent.ctorParameters = function () { return [
                { type: _student_service__WEBPACK_IMPORTED_MODULE_3__["StudentService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
